...
// Command Line Options: e:\Github\MCPDevoir2\MCPDevoir2\test.dfy /verifyAllModules /spillTargetCode:1 /compile:3 /out:bin\test
// test.dfy
...
namespace _module {
  ...
  public abstract class Tree : _ITree {
    public Tree() { }
    private static readonly _ITree theDefault = create_Nil();
    ...
    public static _ITree create_Nil() {
      return new Tree_Nil();
    }
    public static _ITree create_Node(_ITree left, BigInteger val, _ITree right) {
      return new Tree_Node(left, val, right);
    }
    public bool is_Nil { get { return this is Tree_Nil; } }
  ...
  public class Tree_Node : Tree {
    ...
    public Tree_Node(_ITree left, BigInteger val, _ITree right) {
      this._left = left;
      this._val = val;
      this._right = right;
    }
    public override _ITree DowncastClone() {
      if (this is _ITree dt) { return dt; }
      return new Tree_Node(_left, _val, _right);
    }
    public override bool Equals(object other) {
      var oth = other as Tree_Node;
      return oth != null && object.Equals(this._left, oth._left) && this._val == oth._val && object.Equals(this._right, oth._right);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 1;
  ...
  public partial class __default {
    public static _ITree insert(_ITree t, BigInteger i)
    {
      _ITree t_k = Tree.Default();
      if (object.Equals(t, Tree.create_Nil())) {
        t_k = Tree.create_Node(Tree.create_Nil(), i, Tree.create_Nil());
        return t_k;
      }
      if (((t).dtor_val) < (i)) {
        _ITree _0_r;
        _ITree _out0;
        _out0 = __default.insert((t).dtor_right, i);
        _0_r = _out0;
        t_k = Tree.create_Node((t).dtor_left, (t).dtor_val, _0_r);
      } else if (((t).dtor_val) > (i)) {
        _ITree _1_l;
        _ITree _out1;
        _out1 = __default.insert((t).dtor_left, i);
        _1_l = _out1;
        t_k = Tree.create_Node(_1_l, (t).dtor_val, (t).dtor_right);
      }
      t_k = t_k;
      return t_k;
      return t_k;
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> __noArgsParameter)
    {
      _ITree _2_t;
      _ITree _out2;
      _out2 = __default.insert(Tree.create_Nil(), new BigInteger(5));
      _2_t = _out2;
      _ITree _3_c;
      _ITree _out3;
      _out3 = __default.insert(_2_t, new BigInteger(3));
      _3_c = _out3;
      _ITree _4_v;
      _ITree _out4;
      _out4 = __default.insert(_3_c, new BigInteger(6));
      _4_v = _out4;
      Dafny.Helpers.Print(_4_v);
