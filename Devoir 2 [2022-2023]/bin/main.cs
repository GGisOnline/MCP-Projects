...
// Command Line Options: e:\Github\MCPDevoir2\MCPDevoir2\main.dfy /verifyAllModules /spillTargetCode:1 /compile:3 /out:bin\main
// main.dfy
...
namespace _module {
  ...
  public interface _IList {
    bool is_Nil { get; }
    bool is_Cons { get; }
    Dafny.ISequence<char> dtor_Cons_a0 { get; }
    _IList dtor_Cons_a1 { get; }
  ...
  public abstract class List : _IList {
    ...
    public static _IList create_Cons(Dafny.ISequence<char> _a0, _IList _a1) {
      return new List_Cons(_a0, _a1);
    }
    public bool is_Nil { get { return this is List_Nil; } }
    public bool is_Cons { get { return this is List_Cons; } }
    public Dafny.ISequence<char> dtor_Cons_a0 {
      get {
        var d = this;
        return ((List_Cons)d)._a0;
      }
    }
    public _IList dtor_Cons_a1 {
      get {
        var d = this;
        return ((List_Cons)d)._a1;
      }
    }
  ...
  public class List_Cons : List {
    ...
    public readonly _IList _a1;
    public List_Cons(Dafny.ISequence<char> _a0, _IList _a1) {
      this._a0 = _a0;
      this._a1 = _a1;
    }
    public override _IList DowncastClone() {
  ...
  public partial class __default {
    public static _IList[] create(BigInteger n)
    {
      _IList[] a = new _IList[0];
      _IList[] _nw0 = Dafny.ArrayHelpers.InitNewArray1<_IList>(List.Default(), Dafny.Helpers.ToIntChecked(n, "C# arrays may not be larger than the max 32-bit integer"));
      a = _nw0;
      return a;
    }
    public static bool isin(Dafny.ISequence<char> s, _IList[] a)
    {
      bool result = false;
      BigInteger _0_size;
      BigInteger _out0;
      _out0 = __default.counter(a);
      _0_size = _out0;
      if ((_0_size).Sign == 0) {
        result = false;
      } else {
    ...
    public static void @add(_IList[] a, Dafny.ISequence<char> s)
    {
    }
    public static void @remove(_IList[] a, Dafny.ISequence<char> s)
    {
    }
    public static BigInteger counter(_IList[] a)
    {
      BigInteger count = BigInteger.Zero;
      count = new BigInteger((a).Length);
      return count;
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<char>> __noArgsParameter)
    {
      _IList[] _1_test;
      _IList[] _out1;
      _out1 = __default.create(new BigInteger(5));
      _1_test = _out1;
      Dafny.Helpers.Print(new BigInteger((_1_test).Length));
      BigInteger _2_test1;
      BigInteger _out2;
      _out2 = __default.counter(_1_test);
      _2_test1 = _out2;
      bool _3_test2;
      bool _out3;
      _out3 = __default.isin(Dafny.Sequence<char>.FromString("ddfs"), _1_test);
      _3_test2 = _out3;
      Dafny.Helpers.Print(_2_test1);
      Dafny.Helpers.Print(_3_test2);
    }
  }
